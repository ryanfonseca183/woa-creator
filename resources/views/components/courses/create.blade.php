<form wire:submit.prevent="save" novalidate>
    ...
    <div class="row">
        <div class="col">
            <x-controls.input wire:model.defer="curso.data_inicio" type="date" label="Data de inicio" name="curso.data_inicio" required />
        </div>
        <div class="col">
            <x-controls.input wire:model.defer="curso.data_termino" type="date" label="Data de término" name="curso.data_termino" required />
        </div>
    </div>
